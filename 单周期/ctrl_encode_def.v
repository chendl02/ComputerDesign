...
//added
`define ALUOp_SLTI  5'b10100
`define ALUOp_ORI   5'b10101
`define ALUOp_LUI   5'b10110
`define ALUOp_J     5'b10111
`define ALUOp_JAL   5'b11000
`define ALUOp_JR    5'b11001
`define ALUOp_ADDI  5'b11010
`define ALUOp_SW    5'b11011
